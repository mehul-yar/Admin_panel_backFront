...
// Testimonial routes
router.post('/testi', upload.single('image'), testimonialController.createTestimonial);  // Add multer middleware here
router.get('/testi/:id', testimonialController.getTestimonialById);
router.put('/testi/:id', upload.single('image'), testimonialController.updateTestimonial);  // Add multer middleware here
router.delete('/testi/:id', testimonialController.deleteTestimonial);
router.get('/testi', testimonialController.getAllTestimonials);
